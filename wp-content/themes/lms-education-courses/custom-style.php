...
/*------------------ Slider Opacity -------------------*/
	...
	$lms_education_courses_footer_icon = get_theme_mod('lms_education_courses_footer_icon');
	if($lms_education_courses_footer_icon == false){
		$lms_education_courses_custom_css .='#footer-2 p{';
			$lms_education_courses_custom_css .='width:100%; text-align:center; float:none;';
		$lms_education_courses_custom_css .='}';
	}
