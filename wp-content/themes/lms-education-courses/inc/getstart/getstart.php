    ...
    <div class="tab-sec">
		...
		<div id="lite_theme" class="tabcontent open">
			...
			<div class="lite-theme-tab" style="<?php echo esc_attr($lms_education_courses_plugin_custom_css); ?>">
				...
				<hr class="h3hr">
				<p><?php esc_html_e('LMS Education Courses is a website template designed especially for schools and education related websites. Its a special design that helps you create an online space for learning, just like a classroom but on the internet. Imagine it as a tool that turns your website into an interactive and organized learning hub. With this theme, you can easily offer different courses, like you would in a real school, making it perfect for teachers, tutors, or anyone who wants to share knowledge. The theme provides a user-friendly setup, so you dont need to be a tech expert to use it. Its designed to be as easy as possible, even if youre not familiar with complicated website stuff. The coolest part is that your students can access the courses from anywhere, anytime. Its like carrying a school in your pocket! The theme also helps you keep things organized – you can have different sections for various subjects, assignments, and even a way for students to interact with each other. This theme is a fantastic way to bring education to the digital world, making it accessible and enjoyable for everyone interested in expanding their knowledge. So, if you want to create an online learning space hassle-free, this theme is your go-to tool.','lms-education-courses'); ?></p>
				...
				<div class="table-image">
					<table class="tablebox">
						...
						<tbody>
							...
							<tr>
								<td><?php esc_html_e('Slider Settings', 'lms-education-courses'); ?></td>
								<td class="table-img"><span class="dashicons dashicons-saved"></span></td>
								<td class="table-img"><span class="dashicons dashicons-saved"></span></td>
							</tr>
							<tr class="odd">
								<td><?php esc_html_e('Number of Slides', 'lms-education-courses'); ?></td>
								<td class="table-img"><?php esc_html_e('4', 'lms-education-courses'); ?></td>
								<td class="table-img"><?php esc_html_e('Unlimited', 'lms-education-courses'); ?></td>
							</tr>
							<tr>
								<td><?php esc_html_e('Template Pages', 'lms-education-courses'); ?></td>
								<td class="table-img"><?php esc_html_e('3', 'lms-education-courses'); ?></td>
								<td class="table-img"><?php esc_html_e('6', 'lms-education-courses'); ?></td>
							</tr>
							<tr class="odd">
							...
							<tr>
								...
								<td class="table-img"><?php esc_html_e('10', 'lms-education-courses'); ?></td>
							</tr>
							<tr class="odd">
							...
							<tr class="odd">
								<td><?php esc_html_e('Page Templates & Layout', 'lms-education-courses'); ?></td>
								<td class="table-img">0</td>
								<td class="table-img"><?php esc_html_e('2(Left/Right Sidebar)', 'lms-education-courses'); ?></td>
							</tr>
							<tr>
