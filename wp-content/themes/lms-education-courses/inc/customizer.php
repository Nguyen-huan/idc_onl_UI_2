...
function lms_education_courses_customize_register( $wp_customize ) {
  ...
  $wp_customize->add_control('lms_education_courses_footer_widgets_content',array(
	...
	// footer social icon
	$wp_customize->add_setting( 'lms_education_courses_footer_icon',array(
	  'default' => false,
	  'transport' => 'refresh',
	  'sanitize_callback' => 'lms_education_courses_switch_sanitization'
	) );
	$wp_customize->add_control( new LMS_Education_Courses_Toggle_Switch_Custom_Control( $wp_customize, 'lms_education_courses_footer_icon',array(
	  'label' => esc_html__( 'Footer Social Icon','lms-education-courses' ),
	  'section' => 'lms_education_courses_footer'
	)));
