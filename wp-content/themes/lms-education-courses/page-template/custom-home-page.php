                  ...
                  <div class="inner_carousel">
                    ...
                    <?php if( get_theme_mod('lms_education_courses_slider_button_text','Get Start') != ''){ ?>
                      <div class="more-btn mt-0 my-lg-4 my-md-2 wow slideInRight delay-1000" data-wow-duration="2s">
                       <a class="p-3" href="<?php the_permalink(); ?>"><?php echo esc_html(get_theme_mod('lms_education_courses_slider_button_text',__('Get Start','lms-education-courses')));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('lms_education_courses_slider_button_text',__('Get Start','lms-education-courses')));?></span></a>
                      </div>
                    <?php } ?>
