jQuery(document).ready(function($) {
    'use strict';
    var this_obj = magazine_news_agency_plugin_activate_plugin;

    $('#wpelemento_importer_editor .plugin-activation-redirect a').addClass('wpi-redirect-to-dashboard');

    $(document).on('click', '.magazine-news-agency-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message magazine-news-agency-plugin-install');
                button.addClass('button-primary magazine-news-agency-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.magazine-news-agency-recommended-plugins .magazine-news-agency-activation-note').css('display','block');
    ...
    $(document).on('click', '.magazine-news-agency-plugin-activate', function(event) {
