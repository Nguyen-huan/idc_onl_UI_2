      ...
      <div class="row pt-2">
        <div class="col-lg-6 col-md-6 align-self-center">
          <p class="mb-0 py-3 text-center text-md-left">
            <?php
              if (!get_theme_mod('magazine_news_agency_footer_text') ) { ?>    
              <a href="<?php echo esc_url(__('https://www.wpelemento.com/elementor/free-magazine-wordpress-theme/', 'magazine-news-agency' )); ?>" target="_blank">  
                <?php esc_html_e('Magazine News Agency WordPress Theme','magazine-news-agency'); ?>
              </a>
            <?php } else {
                echo esc_html(get_theme_mod('magazine_news_agency_footer_text'));
              }
            ?>
            <?php if ( get_theme_mod('magazine_news_agency_copyright_enable', true) == true ) : ?>
            <?php
              /* translators: %s: WP Elemento */
              printf( esc_html__( ' By %s', 'magazine-news-agency' ), 'WP Elemento' ); ?>
            <?php endif; ?>
          </p>
        </div>
        <div class="col-lg-6 col-md-6 align-self-center text-center text-md-right">
          <?php if ( get_theme_mod('magazine_news_agency_copyright_enable', true) == true ) : ?>
            <a href="<?php echo esc_url(__('https://wordpress.org','magazine-news-agency') ); ?>" rel="generator"><?php  /* translators: %s: WordPress */ printf( esc_html__( 'Proudly powered by %s', 'magazine-news-agency' ), 'WordPress' ); ?></a>
          <?php endif; ?>
        </div>
      </div>
      <?php if ( get_theme_mod('magazine_news_agency_scroll_enable_setting')) : ?>
        <div class="scroll-up">
